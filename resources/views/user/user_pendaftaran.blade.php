...
@section('user')
                        ...
                        <div class="card mb-3 bg-danger text-white">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="card-text mb-0">Edit Data Anda Pada Halaman hasil seleksi jika terdapat data yang
                                        perlu diubah</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            statusAyah.addEventListener('change', toggleWaliSection);
            statusIbu.addEventListener('change', toggleWaliSection);
