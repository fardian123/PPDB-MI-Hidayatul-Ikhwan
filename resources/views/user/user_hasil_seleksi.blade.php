                ...
                @if($pendaftaran->status_pendaftaran == 'valid')
                    <div class="card mb-3 bg-success text-white">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-1">Selamat, pendaftaran Anda Terverifikasi!</h5>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <a class="btn btn-sm
                                        ...
                                        @if($pendaftaran->status_pendaftaran == 'pending')
                                            Menunggu Verifikasi
                                        @elseif($pendaftaran->status_pendaftaran == 'valid')
                                            Terverifikasi
                                        @else
                                            Verifikasi Ditolak
                                        @endif
                                    ...
                                    <a href="#"
                                        class="btn btn-sm btn-primary {{ $pendaftaran->status_pendaftaran == 'valid' ? 'disabled' : '' }}"
                                        data-bs-toggle="modal" data-bs-target="#modalEditData"> Edit</a>
                                    <a href="" class="btn btn-sm btn-info" data-bs-toggle="modal"
                                        data-bs-target="#modalLihatData">Lihat</a>
                                    <a href=""
                                        class="btn btn-sm btn-danger {{ $pendaftaran->status_pendaftaran == 'valid' ? 'disabled' : '' }}"
                                        data-bs-toggle="modal" data-bs-target="#modalHapusData">Hapus</a>
                                </div>
                            </div>
                            @if($pendaftaran->status_pendaftaran == 'valid')
            ...
            <div class="container-fluid">
                <div class="card mb-3 bg-danger text-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title mb-1">Anda Belum Melakukan Pendaftaran</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p><strong>{{ $pendaftaran->jenis_kelamin ?? 'Belum ada data' }}</strong></p>
                    </div>
                    <div class="mb-3">
                    ...
                    <form method="POST" action="{{ route('user.pendaftaran.update') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="nomor_kk" id="nomor_kk" placeholder="Nomor nomor_kk"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="status_ayah" class="form-label">Status hidup ayah</label>
                        ...
                        <div id="section-wali"
                            ...
                            <h5 class="mt-4">Keterangan Wali Murid(Wajib Diisi Jika Kedua OrangTua Sudah Tiada )</h5>
                            <div class="row">
                                <div class="col-md-6">
