                        ...
                        <tbody>
                            @foreach($pendaftarans as $pendaftaran)
                                <tr>
                                    ...
                                    <td id="status-{{ $pendaftaran->id }}" class="text-white
                                                        ...
                                                        @elseif ($pendaftaran->status_pendaftaran == 'pending') bg-warning
                                                            @else bg-secondary
                                                        @endif">
                                        {{ ucfirst($pendaftaran->status_pendaftaran ?? 'Belum diatur') }}
                                    </td>
                                    ...
                                    <td style="white-space: nowrap; width: 1%;">
                                        ...
                                        <select class="form-select form-select-sm w-auto"
                                            ...
                                            <option value="valid" {{ $pendaftaran->status_pendaftaran == 'valid' ? 'selected' : '' }}>Valid</option>
                                            <option value="tidak_valid" {{ $pendaftaran->status_pendaftaran == 'tidak_valid' ? 'selected' : '' }}>Tidak Valid</option>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('tempat_lahir') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('tanggal_lahir') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('status_keluarga') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            @error('berat_badan') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            @error('tinggi_badan') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('bertempat_tinggal_pada') <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('telepon') <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('asal_sekolah') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('tgl_ijazah') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('lama_belajar') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('tanggal_diterima') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('kelas_diterima') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('nama_ayah') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('nama_ibu') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('pendidikan_ayah') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('pendidikan_ibu') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('pekerjaan_ayah') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('pekerjaan_ibu') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            @error('hubungan_wali') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            @error('pekerjaan_wali') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('alamat_wali') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('pendidikan_wali') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('telepon_wali') <div class="invalid-feedback">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('kewarganegaraan') <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('KIP') <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('KIS') <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @error('KKS') <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
