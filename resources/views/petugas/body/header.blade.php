    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                ...
                <li><a class="dropdown-item d-flex align-items-center" href="{{route('petugas.profile')}}"><i
                                class="bx bx-user fs-5"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('petugas.change.password')}}"><i
                                class="bx bx-cog fs-5"></i><span>Change Password</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('petugas.dashboard')}}"><i
